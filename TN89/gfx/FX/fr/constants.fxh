...
// --------------------------------------------------------------
// A collection of constants that can be used to tweak the shaders THX 24/7 NIGHT MOD DEVS
...
static const float3 DayAmbientMapPosX = float3(0.0, 0.0, 0.0);  // right
static const float3 DayAmbientMapNegX = float3(0.15, 0.15, 0.15);  // left
static const float3 DayAmbientMapPosY = float3(0.03, 0.03, 0.03);  // kills everything
static const float3 DayAmbientMapNegY = float3(0.0, 0.0, 0.0);  // from under
static const float3 DayAmbientMapPosZ = float3(0.0502, 0.0502, 0.0502);  // top
static const float3 DayAmbientMapNegZ = float3(0.033, 0.033, 0.033);  // bottom
...
static const float3 NightAmbientMapPosZ = float3(0.15, 0.15, 0.15);  // top
static const float3 NightAmbientMapNegZ = float3(0.14, 0.14, 0.14);  // bottom

// NOTE: regular unit ambient colors set from defines. this is night
static const float3 NightAmbientPosX = float3(0.0, 0.0, 0.0);  // right
static const float3 NightAmbientNegX = float3(0.0, 0.0, 0.0);  // left
static const float3 NightAmbientPosY = float3(0.0, 0.0, 0.0);  // kills everything
static const float3 NightAmbientNegY = float3(0.0, 0.0, 0.0);  // from under
static const float3 NightAmbientPosZ = float3(0.0, 0.0, 0.0);  // top
static const float3 NightAmbientNegZ = float3(0.0, 0.0, 0.0);  // bottom
...
// ------------------    TERRAIN        -------------------------
// --------------------------------------------------------------
static const float CITY_LIGHTS_TILING 			= 0.05103;
...
static const float 	SNOW_OPACITY_MIN			= 0.6f;
...
// ------------------    HDR          	-------------------------
// --------------------------------------------------------------
static const float3 LUMINANCE_VECTOR  			= float3(0.0f, 0.0f, 0.0f);
...
static const float  SHADOW_WEIGHT_TERRAIN    	= 0.1f;
static const float  SHADOW_WEIGHT_MAP    		= 0.1f;
...
static const float GB_OPACITY_NEAR = 0.90f; // Transparency when camera is near
static const float GB_OPACITY_FAR = 0.90f;  // Transparency when camera is far
